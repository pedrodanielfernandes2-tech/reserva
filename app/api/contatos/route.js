...
export async function POST(request) {
  ...
  const { nome, email, celular, recebe_todas, recebe_som, recebe_projecao, recebe_fotografia, recebe_mesa_cadeira } = body;
  ...
  const rows = await sql`
    INSERT INTO contatos_notificacao
      (id, nome, email, celular, recebe_todas, recebe_som, recebe_projecao, recebe_fotografia, recebe_mesa_cadeira)
    VALUES
      (${id}, ${nome.trim()}, ${email.trim()}, ${(celular||'').trim()},
