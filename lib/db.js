...
export async function ensureSchema() {
  ...
  `;
  await sql`ALTER TABLE salas ADD COLUMN IF NOT EXISTS capacidade INTEGER DEFAULT 0;`;
  await sql`ALTER TABLE salas ADD COLUMN IF NOT EXISTS ordem INTEGER DEFAULT 0;`;
  await sql`ALTER TABLE salas ADD COLUMN IF NOT EXISTS foto_url TEXT DEFAULT '';`;
  ...
  `;
  await sql`ALTER TABLE contatos_notificacao ADD COLUMN IF NOT EXISTS celular TEXT DEFAULT '';`;
  ...
  await sql`
    CREATE TABLE IF NOT EXISTS audit_log (
      ...
      hora_inicio TEXT NOT NULL,
      hora_fim TEXT NOT NULL,
      executado_por TEXT DEFAULT 'admin',
